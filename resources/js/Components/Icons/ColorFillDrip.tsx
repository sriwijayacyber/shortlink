...
const ColorFillDrip = (props: SVGProps) => {
   return (
      <svg
      ...
      >
         ...
         <path
            fill="currentColor"
            style={{ opacity: 0.4 }}
            d="M67.5 288H386.7L238.6 436.1c-12.5 12.5-32.8 12.5-45.3 0L75.9 318.6c-8.3-8.3-11.1-20-8.4-30.6zM512 512c-35.3 0-64-28.7-64-64c0-25.2 32.6-79.6 51.2-108.7c6-9.4 19.5-9.4 25.5 0C543.4 368.4 576 422.8 576 448c0 35.3-28.7 64-64 64z"
         />
      </svg>
   );
};

export default ColorFillDrip;
